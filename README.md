...
![](https://github.com/1aaronh/ahume_capstone_DSI-cc13/blob/master/images/rolling_avg_chart.png)
...
![](https://github.com/1aaronh/ahume_capstone_DSI-cc13/blob/master/images/rnn_3mo_rate.png)

Regular Neural Net


![](https://github.com/1aaronh/ahume_capstone_DSI-cc13/blob/master/images/rnn_3mo_mape.png)
...
![](https://github.com/1aaronh/ahume_capstone_DSI-cc13/blob/master/images/rnn_reg3mo.png)

Neural Net with Dropout (60% keeping probability):
The regularization is making a bad situation worse with the 3 month target.


![](https://github.com/1aaronh/ahume_capstone_DSI-cc13/blob/master/images/rnn3mo_regdrop_mape.png)

Very large erors that again validate what we see on the line plot.


![](https://github.com/1aaronh/ahume_capstone_DSI-cc13/blob/master/images/lstm_regular_3MO.png)
...
![](https://github.com/1aaronh/ahume_capstone_DSI-cc13/blob/master/images/lstm3mo_mape.png)
...
![](https://github.com/1aaronh/ahume_capstone_DSI-cc13/blob/master/images/rnn30yr.png)
...
![](https://github.com/1aaronh/ahume_capstone_DSI-cc13/blob/master/images/rnn_reg30yr.png)

Neural Net with Dropout (60% keeping probability):
The regularization is over-correcting but still shows an interesting prediction pattern.


![](https://github.com/1aaronh/ahume_capstone_DSI-cc13/blob/master/images/rnn_reg30yr_mape_.02keep.png)

y-axis is still at a reasaonable scale but with much larger MAPE percentages.


![](https://github.com/1aaronh/ahume_capstone_DSI-cc13/blob/master/images/lstm_30yr_preds.png)

LSTM: A decent pattern of predicting with a notable interruption.


![](https://github.com/1aaronh/ahume_capstone_DSI-cc13/blob/master/images/lstm_30yr_mape.png)
